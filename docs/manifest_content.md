...
windowsupdate | copy | /Packages/Plugins/Microsoft.CPlat.Core.WindowsPatchExtension/\*/config.txt
windowsupdate | copy | /Packages/Plugins/Microsoft.CPlat.Core.WindowsPatchExtension/\*/HandlerEnvironment.js<br>on
...
windowsupdate | copy | /$Windows.~BT/Sources/Rollback/setupact.log
windowsupdate | copy | /$Windows.~BT/Sources/SafeOS/Panther/setupact.log
windowsupdate | copy | /$Windows.~BT/Sources/SafeOS/Panther/setuperr.log
windowsupdate | copy | /$Windows.~WS/Sources/Panther/setupact.log
windowsupdate | copy | /$Windows.~WS/Sources/Panther/setuperr.log
windowsupdate | copy | /$Windows.~WS/Sources/Panther/miglog.xml

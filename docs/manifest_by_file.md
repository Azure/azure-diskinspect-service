...
/etc/cni/net.d/10-calico.conflist | aks 
/etc/cni/net.d/10-containerd-net.conflist | aks 
...
*File was created by running [parse_manifest.py](../tools/parse_manifest.py) on `2021-02-11 15:57:32.807940`*